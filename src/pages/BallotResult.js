                ...
                <div className="w-full max-w-lg p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    <div className="relative overflow-x-auto">
                        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                            ...
                            <tr>
                                <th scope="col" className="px-6 py-3 font-bold text-lg text-gray-500">
                                    Name
                                </th>
                                <th scope="col" className="px-6 py-3 font-bold text-lg text-gray-500">
                                    Rank    
                            ...
                            <tbody>
                                {ballotResult.map(result => (
                                    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        <td className="px-6 py-4 font-semibold text-md text-gray-500">{result.userName}</td>
                                        <td className="px-6 py-4 font-semibold text-md text-gray-500">{result.rank}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
