      ...
      <section className="bg-white dark:bg-gray-900 mb-32">
        <div className="pb-24 lg:pb-16 px-4 mx-auto max-w-screen-md">
            <p className="mb-8 lg:mb-16 text-center text-gray-900 dark:text-gray-400 sm:text-xl">
              Got a technical issue? Want to send
              feedback?
              We're here to answer your questions and provide support. 
              Reach out to us and let us assist you in making your ballot 
            ...
            >
                <div>
                    <label for="Username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Name</label>
                    <input 
                      value={userName}
                ...
                <div>
                    ...
                    <input 
                      ...
                      type="email" className="hover:shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" 
                ...
                <div className="sm:col-span-2">
                    ...
                    <textarea 
                      ...
                      rows="6" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg hover:shadow-sm border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
