...
const filteredData = members.filter(obj => obj.telephone === getCookie('authUserTelephone'));
                ...
                {sortedGroups.map(group => (
                    <div className="py-2">
                        <Link to={`/ballots/${slugify(group)}/result?group=${group}`} >
                            <button className="block items-center w-full justify-center p-5 text-base font-bold text-gray-900 rounded-lg bg-blue-50 hover:text-blue-500 hover:border hover:border-blue-500 hover:bg-blue-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
