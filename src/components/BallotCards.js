  ...
  return (
    <div>
      <div className="py-2 px-4 mx-auto max-w-screen-sm text-center lg:py-2 z-10 relative">
        <h1 className="mb-8 pt-8 text-xl tracking-tight leading-none text-gray-500 md:text-2xl lg:text-2xl dark:text-white">
          {selectedGroup.length > 0 ? selectedGroup + ' has ' : 'No group selected'} {' '}
        ...
        <h1 className="mb-4 text-2xl font-bold tracking-tight leading-none text-gray-900 md:text-2xl lg:text-2xl dark:text-white">
          {members.length > 1 ? 'Click a box to ballot ' : ''}
        </h1>
        <small className="text-red-700 font-bold">Note: You can only choose once</small>
